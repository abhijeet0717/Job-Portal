...
const Job = ({ job }) => {//recieve the job details as props
    ...
    return (
        <div className='p-5 rounded-md shadow-xl bg-white border border-gray-100'>
            ...
            <div className='flex items-center gap-4 mt-4'>
                <Button onClick={() => navigate(`/description/${job?._id}`)} variant="outline" className="rounded-lg">Details</Button>{/*slug used*/}
                <Button className="bg-[#7209b7] rounded-lg">Save For Later</Button>
            </div>
            <div>
                {/* <ApplyJobDialog open={open} setOpen={setOpen} />  as no use of it*/}
