...
const CreateJobs = () => {
    ...
    const { companies } = useSelector(store => store.company);//to select the company for whichjob is posted
                        ...
                        </div>
                        {
                            companies.length !== 0 && (
                                <Select onValueChange={handleSelectChange}>
                                    ...
                                    <SelectContent>
                                        <SelectGroup>
                                            {//can select the company from the list of companies(posted by the admin)
