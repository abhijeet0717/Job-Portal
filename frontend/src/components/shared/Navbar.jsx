                ...
                <div className='flex items-center gap-12'>
                    <ul className='flex font-medium items-center gap-5'>
                        {
                            ...
                            authUser && authUser.role === "recruiter" ? (//first check authUser is not null then check role , if direct check role then it will give error if authUser is null 
                                //if user is recruite then render
                                <>
                    ...
                    </ul>
                    {
                        !authUser ? (
                            ...
                            <ProfilePopover />//to see the popover (profile iomage the pop up come on clicking it)
                        )
                    }
